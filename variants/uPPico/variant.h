...
#define PIN_SPI_MISO         (4) // P0.04
#define PIN_SPI_MOSI         (5) // P0.05
#define PIN_SPI_SCK         (23) // P0.23
...
#define PIN_WIRE_SDA         (3u) // P0.03
#define PIN_WIRE_SCL         (1u) // P0.01
